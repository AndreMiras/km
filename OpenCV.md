...
Use the [Makefile](attachments/Makefile.opencv) provided to compile and install
OpenCV library.
...
Most likely you need to `pip install numpy` delete your opencv build and build
again.
