...
The idea is to install it manually to have better control of where to install
it. At the end the installation is just extracting the archive and sourcing a
script.
