...
This is quick'n dirty guide for installing LineageOS Android Distribution on the
...
- [TWRP](https://www.androidfilehost.com/?w=files&flid=56315)
  (3.0.2.0-20161005-j5nltexx)
...
- Kies3Setup.exe: Samsung software might also be used for downgrading to
  Lollipop
...
4. Flash "TWRP" custom recovery image using ODIN
5. Reboot the device in the custom recovery mode (power+home+volume-up)
6. Wipe the device from the "Wipe" menu
7. Install the custom LineageOS zip file from the "Install" menu
8. Install the GApp zip file from the "Install" menu
9. Reboot the device & enjoy
...
I like to do it from the shell using the `adb` command. First find the SDCARD
path, you can use `adb shell mount` to see in which directory it's mounted.
Then:
...
Well, I know, I'm sorry, or you could try to give
[Heimdall](http://glassechidna.com.au/heimdall/) a try and create a pull request
